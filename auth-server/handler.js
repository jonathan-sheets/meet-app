...
/**
 * SCOPES allows you to set access levels; this is set to read only for now because you don't have acces rights to update the calendar yourself.  For more info, check out the SCOPES documentation at this link: https://developers.google.com/identity/protocols/oauth2/scopes
 */
...
const credentials = {
  ...
  redirect_uris: ["https://jonathan-sheets.github.io/meet-app/"],
  javascript_origins: ["https://jonathan-sheets.github.io", "http://localhost:3000"],
};
